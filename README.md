...
```sh
sudo su
wget https://github.com/kacalayar/FOG/raw/main/fog-debian && chmod +x ./fog-debian && ./fog-debian
```
For Ubuntu Distro:
```sh
sudo su
wget https://github.com/kacalayar/FOG/raw/main/fog-ubuntu && chmod +x ./fog-ubuntu && ./fog-ubuntu
```
